<div class="nk-content ">
            ...
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between">
                    <div class="nk-block-head-content">
                        <span class="preview-title-lg overline-title">invoices</span>
                        ...
                        <div class="toggle-wrap nk-block-tools-toggle">
                            ...
                            <div class="toggle-expand-content" data-content="pageMenu">
                                <ul class="nk-block-tools g-3">
                                    ...
                                    <li class="{{$viewFilters==true?'d-none':''}}">
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control" id="default-04"
                                                   placeholder="Enter Invoice ID" wire:model="searchCode">
                                        </div>
                                    </li>
                                    ...
                                    <li class="{{$searchCodeSelected?'d-none':''}}">
                                        <button type="button" class="btn btn-primary" wire:click="ShowDateRangeModal()">Select Date</button>
                                    </li>
                                    <li class="{{$reportReady?'':'d-none'}}">
                                        <a href="#" class="btn btn-secondary {{$viewFilters==false?'d-none':''}}" wire:click.prevent="downloadPDFStatement"><em class="icon ni ni-download text-light"></em> PDF <div class="ml-3" wire:loading>
                            ...
                            <tr class="nk-tb-item odd {{$loop->odd?'bg-light':''}}" role="row">
                                ...
                                <td class="nk-tb-col">
                                    <div class="user-card">
                                        ...
                                        <div class="user-info">
                                            <span class="tb-lead">{{$purchase['invoice_id']}}</span><span> @can('allow_create') <a href="#" wire:click.prevent="{{$purchase["payment_status"]==1?'InvoicePaymentDetailsModal('.$purchase["invoice_id"].')':'SubmitInvoicePaymentModal('.$purchase["invoice_id"].')'}}"><em class="{{$purchase["payment_status"]==0?"icon ni ni-check-round text-success":""}}"></em> {{$purchase["payment_status"]==1?'':'Complete Payment |'}}</a> @endcan <a href="#" wire:click.prevent="ViewInvoiceModal({{$purchase["invoice_id"]}})"><em class="icon ni ni-search"></em> View Invoice</a> | <a href="#" wire:click.prevent="DownloadInvoice({{$purchase["invoice_id"]}})"><em class="icon ni ni-file-pdf text-danger"></em> Download Invoice</a></span>
                                        </div>
                                    </div>
                                </td>
                                <td class="nk-tb-col">
                                    <div class="user-card">
                                        ...
                                        <div class="user-info">
                                            <span class="tb-lead">{{\App\Models\Branch::find($purchase['branch_id'])->name}}</span>
                                        </div>
                                    </div>
                                </td>
                                <td class="nk-tb-col">
                                    <div class="user-card">
                                        ...
                                        <div class="user-info">
                                            <span class="tb-lead">{{\App\Models\Supplier::find($purchase['supplier_id'])->supplier_code}}</span>
                                        </div>
                                    </div>
                                </td>
                                <td class="nk-tb-col">
                                    <div class="user-card">
                                        ...
                                        <div class="user-info">
                                            <span class="tb-lead">{{\App\Models\Supplier::find($purchase['supplier_id'])->name}}</span>
                                        </div>
                                    </div>
                                </td>
                                <td class="nk-tb-col">
                                    <div class="user-card">
                                        ...
                                        <div class="user-info">
                                            <span class="tb-lead" style="text-align:right;">{{number_format($InvoiceTotal,2)}}</span>
                                        </div>
                                    </div>
                                </td>
                        ...
                        <tr class="nk-tb-item odd" role="row">
                            ...
                            <td class="nk-tb-col">
                                <div class="user-card">
                                    ...
                                    <div class="user-info">
                                        <span class="tb-lead" style="text-align:right;">{{number_format($GrandTotal,2)}}</span>
                                    </div>
                                </div>
                            </td>
    ...
    @include('modals.InvoicePayModal')
    @include('modals.InvoiceViewModal')
