        ...
        <div class="card-inner">
            ...
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between">
                    <div class="nk-block-head-content">
                        <span class="preview-title-lg overline-title">purchase return report</span>
            ...
            <div id="" class=" dt-bootstrap4 no-footer">
                    ...
                    <table class="nk-tb-list nk-tb-ulist no-footer" data-auto-responsive="false" id="" role="grid"
                        ...
                        <thead>
                            <tr class="nk-tb-item nk-tb-head" role="row">
                                ...
                                <th class="nk-tb-col sorting" tabindex="0" aria-controls="DataTables_Table_1"
                                    rowspan="1" colspan="1" aria-label="User: activate to sort column ascending"><span
                                        class="sub-text">Date Purchased</span></th>
                            ...
                            <tr class="nk-tb-item odd {{$loop->odd?'bg-light':''}}" role="row">
                                ...
                                <td class="nk-tb-col">
                                    <div class="user-card">
                                        ...
                                        <div class="user-info">
                                            <span class="tb-lead">{{$purchase->product->name}}</span>
                                        </div>
                                    </div>
                                </td>
                                <td class="nk-tb-col">
                                    <div class="user-card">
                                        ...
                                        <div class="user-info">
                                            <span class="tb-lead">{{$purchase->size->sku}}</span>
                                        </div>
                                    </div>
                                </td>
                                <td class="nk-tb-col">
                                    <div class="user-card">
                                        ...
                                        <div class="user-info">
                                            <span class="tb-lead">{{$purchase->size->name}}</span>
                                        </div>
                                    </div>
                                </td>
                                <td class="nk-tb-col">
                                    <div class="user-card">
                                        ...
                                        <div class="user-info">
                                            <span class="tb-lead">{{number_format($purchase->cost,2)}}</span>
                                        </div>
                                    </div>
                                </td>
                                <td class="nk-tb-col">
                                    <div class="user-card">
                                        ...
                                        <div class="user-info">
                                            <span class="tb-lead">{{$purchase->stock}}</span>
                                        </div>
                                    </div>
                                </td>
                                <td class="nk-tb-col">
                                    <div class="user-card">
                                        ...
                                        <div class="user-info">
                                            <span class="tb-lead">{{$purchase->created_at}}</span>
                                        </div>
                                    </div>
                                </td>
                ...
                <div class="row align-items-center">
                  @if(is_array($purchases)) @else  {{ $purchases->links('pagination.admin') }} @endif
                </div>
                @include('modals.purchaseCancelModal')
