...
class AdminPurchasesReturnsReportComponent extends Component
{
	use WithPagination;
	...
	public function downloadPDF(){
	        ...
	        $to      = Carbon::parse($date_to)
	                 ->endOfDay()          // 2018-09-29 23:59:59.000000
	                 ->toDateTimeString(); // 2018-09-29 23:59:59
	        $purchases=$purchases=Purchase::with('branch')
                        ->with('supplier')
        ...
        (new LogsService('downloaded purchase returns' ,'Admin'))->storeLogs();
			$pdfContent = PDF::loadView('pdf.purchasesReturns',compact(['purchases','branch','from','to','logo']))->output();
    ...
    public function render()
    {
        ...
        return view('livewire.admin-purchases-returns-report-component',['branches'=>$branches,'purchases'=>$purchases,'count'=>$count,'AdminBranchId'=>$AdminBranchId])->layout('layouts.admin');
    }
}
